...
//    @Autowired
    public DataBootstrap( AttributeRepository repoAttribute, DisciplineRepository repoDiscipline,
                          RoleRepository repoRole, UserRepository repoUser){
    ...
    public void run(String... args) throws Exception {
        RoleEntity roleEntity = new RoleEntity("admin",null);
        repoRole.save(roleEntity);
        RoleEntity roleEntity1 = new RoleEntity("student",null);
        repoRole.save(roleEntity1);
        RoleEntity roleEntity2 = new RoleEntity("advisor",null);
        repoRole.save(roleEntity2);

        UserEntity user = new UserEntity("admin","assmin","admin@raptorplan.com","M20949823","",null);
